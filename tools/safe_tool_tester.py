...
DEFAULT_CLASSIFICATIONS = {
    ...
    "safe": [
        ...
        "validate_logbook.py", "validate_action_plan.py", "validate_verdict.py",
        ...
        "metric_aggregator.py", "metrics_collector.py", "qa_metrics_collector.py",
        ...
        "plugin_validator.py", "region_validator.py", "variant_validator.py",
        "idempotence_validator.py", "fixture_validator.py", "lisp_syntax_checker.py",
        "env_config_validator.py", "api_docs_validator.py", "cross_reference_validator.py",
        ...
        "deprecated_template_scanner.py", "deprecated_template_usage.py",
        ...
        "logbook_query.py", "a11y_audit.py", "audit.py", "ux_click_audit.py",
        "eod_summary.py", "template_diff_analyzer.py", "template_lineage.py",
        "traceability_mapper.py", "dependency_graph_generator.py",
        ...
        "region_hash.py", "region_extractor.py", "region_interface_checker.py",
        ...
        "validate_work_order.py", "work_order_validator.py",
    ...
    "sandboxed": [
        ...
        "region_reinserter.py", "update_base_version.py", "update_ssot_section_9.py",
